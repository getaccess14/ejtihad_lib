...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../CSS/viewidc.css">
...
<body>
  ...
  <div class="right-column">
	...
	//$title = $row["title"];
	$sql = "SELECT * FROM vid WHERE username_upload = ?";
	$params = [$loggedUser];

	if (isset($_GET['search'])) {
	  $search = $_GET['search'];
	  $sql = "SELECT * FROM vid WHERE (title LIKE ? OR author LIKE ? OR major LIKE ? OR description LIKE ? OR item_id LIKE ?) AND username_upload = ?";
